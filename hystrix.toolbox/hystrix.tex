...
\fl{}\moduleLeftDash\cl{ {\MODULE} hystrix}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Naturals ,\, TLC}
\fl{}
\fl{ {\p@mmalgorithm} HystrixCircuit {\p@lbrace}}
\fl{ {\p@variables}}\al{4}{1}{ failures \.{=} 0 ,\,}
\fl{ maxFailures \.{\in} 0 \.{\dotdot} 5 ,\,}
\fl{ state \.{=}\@w{closed} ,\,}
\fl{ states \.{=} \{\@w{closed} ,\,\@w{open} \} ,\,}
\fl{ subStates \.{=} \{\@w{up} ,\,\@w{down} \} ,\,}
\fl{ subState \.{\in} subStates ,\,}
\fl{ time \.{=} 0 ,\,}
\fl{ retryTime \.{\in} 1 \.{\dotdot} 5 ,\,}
\fl{ {\p@lbrace}}
\fl{ HYX\_PROCESSING\@s{.5}\textrm{:}\@s{3}}
\fl{ {\p@while} {\p@lparen} {\TRUE} {\p@rparen} {\p@lbrace}}
\fl{ HYX\_CHECK\_CLOSED\_CIRCUIT\@s{.5}\textrm{:}\@s{3}}
 \fl{ {\p@if} {\p@lparen}}\al{16}{2}{ state \.{=}\@w{closed} {\p@rparen}
 {\p@lbrace}}
 \fl{ {\p@if} {\p@lparen}}\al{17}{2}{ subState \.{=}\@w{up}
 {\p@rparen}}\al{17}{6}{ {\p@lbrace}}
 \fl{ HYX\_RESET\_FAILURES\@s{.5}\textrm{:}\@s{3}}\al{18}{1}{ failures \.{:=}
 0 {\p@semicolon}}
\fl{ {\p@rbrace}}\al{19}{1}{ {\p@else}}\al{19}{2}{ {\p@lbrace}}
 \fl{ HYX\_INCREMENT\_FAILURE\@s{.5}\textrm{:}\@s{3}}\al{20}{1}{ failures
 \.{:=} failures \.{+} 1 {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{ HYX\_CHECK\_OPEN\_CIRCUIT \.{:} {\p@else} {\p@lbrace}}
\fl{}
\fl{ {\p@rbrace}}\al{25}{1}{ {\p@semicolon}}
 \fl{ HYX\_CHECK\_FAILURES\@s{.5}\textrm{:}\@s{3}}\al{26}{1}{ {\p@if}
 {\p@lparen} failures \.{\geq} maxFailures {\p@rparen} {\p@lbrace}}
 \fl{ HYX\_OPEN\@s{.5}\textrm{:}\@s{3}}\al{27}{1}{ state \.{:=}\@w{open}
 {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ {\p@rbrace}}
...
\fl{}
\fl{}
 \fl{ {\VARIABLES} failures ,\, maxFailures ,\, state ,\, states ,\, subStates
 ,\, subState ,\, pc}
\fl{}
 \fl{ vars}\al{36}{1}{ \.{\defeq} {\langle} failures ,\, maxFailures ,\, state
 ,\, states ,\, subStates ,\, subState ,\, pc {\rangle}}
\fl{}
\fl{ Init}\al{38}{1}{ \.{\defeq}}\al{38}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{39}{1}{ failures \.{=} 0}
\fl{ \.{\land}}\al{40}{1}{ maxFailures \.{\in} 0 \.{\dotdot} 5}
\fl{ \.{\land}}\al{41}{1}{ state \.{=}\@w{closed}}
\fl{ \.{\land}}\al{42}{1}{ states \.{=} \{\@w{closed} ,\,\@w{open} \}}
\fl{ \.{\land}}\al{43}{1}{ subStates \.{=} \{\@w{up} ,\,\@w{down} \}}
\fl{ \.{\land}}\al{44}{1}{ subState \.{\in} subStates}
\fl{ \.{\land}}\al{45}{1}{ pc \.{=}\@w{HYX\_PROCESSING}}
\fl{}
 \fl{ HYX\_PROCESSING \.{\defeq}}\al{47}{2}{ \.{\land}}\al{47}{3}{ pc
 \.{=}\@w{HYX\_PROCESSING}}
\fl{ \.{\land}}\al{48}{1}{ pc \.{'} \.{=}\@w{HYX\_CHECK\_CIRCUIT}}
 \fl{ \.{\land}}\al{49}{1}{ {\UNCHANGED} {\langle}}\al{49}{3}{ failures ,\,
 maxFailures ,\, state ,\, states ,\,}
\fl{ subStates ,\, subState {\rangle}}
\fl{}
 \fl{ HYX\_CHECK\_CIRCUIT \.{\defeq}}\al{52}{2}{ \.{\land}}\al{52}{3}{ pc
 \.{=}\@w{HYX\_CHECK\_CIRCUIT}}
\fl{ \.{\land}}\al{53}{1}{ {\IF}}\al{53}{2}{ state \.{=}\@w{closed}}
 \fl{ \.{\THEN}}\al{54}{1}{ \.{\land}}\al{54}{2}{ {\IF}}\al{54}{3}{ subState
 \.{=}\@w{up}}
 \fl{ \.{\THEN}}\al{55}{1}{ \.{\land}}\al{55}{2}{ pc \.{'}}\al{55}{4}{
 \.{=}}\al{55}{5}{\@w{HYX\_RESET\_FAILURES}}
 \fl{ \.{\ELSE}}\al{56}{1}{ \.{\land}}\al{56}{2}{ pc \.{'}}\al{56}{4}{
 \.{=}}\al{56}{5}{\@w{HYX\_INCREMENT\_FAILURE}}
 \fl{ \.{\ELSE}}\al{57}{1}{ \.{\land}}\al{57}{2}{ pc \.{'}
 \.{=}\@w{HYX\_CHECK\_FAILURES}}
 \fl{ \.{\land}}\al{58}{1}{ {\UNCHANGED} {\langle}}\al{58}{3}{ failures ,\,
 maxFailures ,\, state ,\, states ,\,}
\fl{ subStates ,\, subState {\rangle}}
\fl{}
 \fl{ HYX\_RESET\_FAILURES \.{\defeq}}\al{61}{2}{ \.{\land}}\al{61}{3}{ pc
 \.{=}\@w{HYX\_RESET\_FAILURES}}
\fl{ \.{\land}}\al{62}{1}{ failures \.{'} \.{=} 0}
\fl{ \.{\land}}\al{63}{1}{ pc \.{'} \.{=}\@w{HYX\_CHECK\_FAILURES}}
 \fl{ \.{\land}}\al{64}{1}{ {\UNCHANGED} {\langle}}\al{64}{3}{ maxFailures ,\,
 state ,\, states ,\, subStates ,\,}
\fl{ subState {\rangle}}
\fl{}
 \fl{ HYX\_INCREMENT\_FAILURE \.{\defeq}}\al{67}{2}{ \.{\land}}\al{67}{3}{ pc
 \.{=}\@w{HYX\_INCREMENT\_FAILURE}}
\fl{ \.{\land}}\al{68}{1}{ failures \.{'} \.{=} failures \.{+} 1}
\fl{ \.{\land}}\al{69}{1}{ pc \.{'} \.{=}\@w{HYX\_CHECK\_FAILURES}}
 \fl{ \.{\land}}\al{70}{1}{ {\UNCHANGED} {\langle}}\al{70}{3}{ maxFailures ,\,
 state ,\, states ,\, subStates ,\,}
\fl{ subState {\rangle}}
\fl{}
 \fl{ HYX\_CHECK\_FAILURES \.{\defeq}}\al{73}{2}{ \.{\land}}\al{73}{3}{ pc
 \.{=}\@w{HYX\_CHECK\_FAILURES}}
\fl{ \.{\land}}\al{74}{1}{ {\IF}}\al{74}{2}{ failures \.{\geq} maxFailures}
 \fl{ \.{\THEN}}\al{75}{1}{ \.{\land}}\al{75}{2}{ pc \.{'}}\al{75}{4}{
 \.{=}}\al{75}{5}{\@w{HYX\_OPEN}}
 \fl{ \.{\ELSE}}\al{76}{1}{ \.{\land}}\al{76}{2}{ pc \.{'}}\al{76}{4}{
 \.{=}}\al{76}{5}{\@w{HYX\_PROCESSING}}
 \fl{ \.{\land}}\al{77}{1}{ {\UNCHANGED} {\langle}}\al{77}{3}{ failures ,\,
 maxFailures ,\, state ,\, states ,\,}
\fl{ subStates ,\, subState {\rangle}}
\fl{}
 \fl{ HYX\_OPEN \.{\defeq}}\al{80}{2}{ \.{\land}}\al{80}{3}{ pc
 \.{=}\@w{HYX\_OPEN}}
\fl{ \.{\land}}\al{81}{1}{ state \.{'} \.{=}\@w{open}}
\fl{ \.{\land}}\al{82}{1}{ pc \.{'} \.{=}\@w{HYX\_PROCESSING}}
 \fl{ \.{\land}}\al{83}{1}{ {\UNCHANGED} {\langle} failures ,\, maxFailures
 ,\, states ,\, subStates ,\, subState {\rangle}}
\fl{}
 \fl{ Next}\al{85}{1}{ \.{\defeq}}\al{85}{2}{ HYX\_PROCESSING \.{\lor}
 HYX\_CHECK\_CIRCUIT \.{\lor} HYX\_RESET\_FAILURES}
 \fl{ \.{\lor} HYX\_INCREMENT\_FAILURE \.{\lor} HYX\_CHECK\_FAILURES \.{\lor}
 HYX\_OPEN}
\fl{}
 \fl{ Spec}\al{88}{1}{ \.{\defeq}}\al{88}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
\fl{}
\fl{}
\fl{ HyxOK \.{\defeq}}\al{92}{2}{ \.{\land}}\al{92}{3}{ state \.{\in} states}
\fl{ \.{\land}}\al{93}{1}{ subState \.{\in} subStates}
\fl{}
\fl{}\bottombar\cl{}
\fl{}
\fl{}
